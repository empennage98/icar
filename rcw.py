...
for seed in range(5):
    for gamma in [0.05, 0.02, 0.01]:
        ...
        for only_car, baseline_mode, guessbestconf in configs:
            ...
            env = RuntimeMatrixEnvironment('./dataset/cplex_rcw/cplex_rcw_rt_seed{}.npy'.format(520+seed))
            ...
            with open('rcw/rcw_a_rsf_epsilon{}_delta{}_gamma{}_car{}_baseline{}_gbc{}_seed{}.dump'.format(settings['epsilon'],delta,gamma,only_car, baseline_mode, guessbestconf, 520+seed), 'wb') as f:
                pickle.dump(icar.env.run_so_far, f)
            with open('rcw/rcw_a_rt_delta{}.dump'.format(delta), 'wb') as f:
