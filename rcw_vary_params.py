        ...
        for delta in [0.025, 0.05, 0.075, 0.1]:
            for gamma in [0.02]:
                ...
                for only_car, baseline_mode, guessbestconf in configs:
                    ...
                    with open('rcw/rcw_vary_rsf_epsilon{}_delta{}_gamma{}_car{}_baseline{}_gbc{}_seed{}.dump'.format(settings['epsilon'],delta,gamma,only_car, baseline_mode, guessbestconf, 520+seed), 'wb') as f:
                        pickle.dump(icar.env.run_so_far, f)
                    with open('rcw/rcw_vary_rt.dump', 'wb') as f:
